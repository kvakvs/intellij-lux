...
public class LuxMlSendLnImpl extends ASTWrapperPsiElement implements LuxMlSendLn {

  public LuxMlSendLnImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuxVisitor visitor) {
    visitor.visitMlSendLn(this);
  }
  ...
  public PsiElement getKMlSendLn() {
    return findNotNullChildByType(K_ML_SEND_LN);
  }
