...
public class LuxMetaConfigImpl extends ASTWrapperPsiElement implements LuxMetaConfig {

  public LuxMetaConfigImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuxVisitor visitor) {
    visitor.visitMetaConfig(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getKConfig() {
    return findNotNullChildByType(K_CONFIG);
  }
